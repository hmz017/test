...
import { datacircle, optionscircle, rowData } from './makeData';
import { Column, Row,  } from 'carbon-components-react';
import {Card, CARD_SIZES, } from 'carbon-addons-iot-react';
import { TextInput } from 'carbon-components-react';
import { DataTable, Table, TableHead, TableRow, TableHeader, TableBody, TableCell,TableToolbarSearch } from 'carbon-components-react';
...
export const com = () => {
  ...
  return (
    <>
      <PageHeader title='COMMENTS' actionBarItems={actionBarItems} ></PageHeader>
